...
try {
    thirdTransaction = await transactionData.addTransaction(myUser._id.toString(), "Cash", 300, "third transaction", "Bills", today)
} catch (error) {
    console.log(error)
}
...
try {
    forthTransaction = await transactionData.addTransaction(myUser._id.toString(), "Cash", 400, "Forth transaction", "Shopping", today)
} catch (error) {
    console.log(error)
}
